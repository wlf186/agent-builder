...
View detailed information about a skill including its files, documentation, and metadata. Browse skill content with a file tree navigation.
...
- [SkillUploadDialog](/en/advanced/skill-upload-dialog)
