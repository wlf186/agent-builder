...
Upload custom skill packages in ZIP format. Each package must contain a SKILL.md file as the skill definition.
...
- [SkillDetailDialog](/en/advanced/skill-detail-dialog)
