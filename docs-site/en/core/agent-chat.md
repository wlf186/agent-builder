...
The main conversation area where you interact with your AI agent. Type messages, attach files, and see real-time responses with typewriter effect.
...
- [KnowledgeBaseSelector](/en/core/knowledge-base-selector)
- [FileUploader](/en/core/file-uploader)
