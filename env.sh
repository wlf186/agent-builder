...
unset _AGENT_BUILDER_QUALIFICATION_SYNC_COUNTER
unset _AGENT_BUILDER_SYNC_COUNTER_FILE _AGENT_BUILDER_SYNC_COUNTER_ROLE
unset _AGENT_BUILDER_SYNC_COUNTER_REQUIRED
unset _AGENT_BUILDER_SYNC_COUNTER_SELFTEST_NO_GLOBAL_SYNC
